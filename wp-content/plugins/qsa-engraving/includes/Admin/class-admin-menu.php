        ...
        <div class="qsa-settings-wrap">
            <form method="post" action="options.php" id="qsa-settings-form">
                ...
                <div class="qsa-settings-section">
                    ...
                    <p class="description">
                        <?php esc_html_e( 'Configure the Micro-ID decoder pages that allow customers to look up their LED modules.', 'qsa-engraving' ); ?>
                    </p>
                        ...
                        <tr>
                            ...
                            <td>
                                <label>
                                    ...
                                    <?php esc_html_e( 'Enable the Micro-ID decoder pages', 'qsa-engraving' ); ?>
                                </label>
                                <p class="description">
                                    <?php esc_html_e( 'When enabled, the /id and /decode URLs will be accessible for customers to look up module information.', 'qsa-engraving' ); ?>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e( 'Decoder URLs', 'qsa-engraving' ); ?></th>
                            <td>
                                <p style="margin: 0 0 8px;">
                                    <strong><?php esc_html_e( 'Manual Decoder:', 'qsa-engraving' ); ?></strong>
                                    <code><?php echo esc_url( home_url( '/decode' ) ); ?></code>
                                    <?php if ( $settings['microid_decoder_enabled'] ?? false ) : ?>
                                        <a href="<?php echo esc_url( home_url( '/decode' ) ); ?>" target="_blank" rel="noopener noreferrer" class="button button-small" style="margin-left: 10px;">
                                            <?php esc_html_e( 'Open', 'qsa-engraving' ); ?>
                                        </a>
                                    <?php endif; ?>
                                </p>
                                <p class="description" style="margin: 0 0 12px;">
                                    <?php esc_html_e( 'Customers manually match the Micro-ID dot pattern using an interactive grid.', 'qsa-engraving' ); ?>
                                </p>
                                <p style="margin: 0 0 8px;">
                                    <strong><?php esc_html_e( 'Module Info:', 'qsa-engraving' ); ?></strong>
                                ...
                                <p class="description">
                                    <?php esc_html_e( 'Displays module information when accessed with a serial number (e.g., /id?serial=00000123).', 'qsa-engraving' ); ?>
                                </p>
                            </td>
                        </tr>
                    </table>
