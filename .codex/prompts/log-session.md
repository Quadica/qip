...
- Create a session report that documents what changed and what was accomplished during this development session to enable future AI sessions to pick up where we left off
